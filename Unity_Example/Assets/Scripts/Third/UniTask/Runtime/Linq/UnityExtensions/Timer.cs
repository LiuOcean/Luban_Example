...
namespace Cysharp.Threading.Tasks.Linq
{
    public static partial class UniTaskAsyncEnumerable
    {
        ...
        public static void EveryTime(TimeSpan          period,
                                     Action            work,
                                     ...
                                     bool              ignoreTimeScale = false)
        {
            ...
            {
                throw new ArgumentException($"Don't use {nameof(CancellationToken.None)}.", nameof(token));
            }

            Interval(period, updateTiming, ignoreTimeScale).ForEachAsync(_ => { work?.Invoke(); }, token).Forget();
        }
                                     ...
                                     bool              ignoreTimeScale = false)
        {
            ...
            Interval(period, updateTiming, ignoreTimeScale).ForEachAwaitAsync(_ => work, token).Forget();
        }
    ...
    internal class Timer : IUniTaskAsyncEnumerable<AsyncUnit>
    {
        ...
        class _Timer : MoveNextSource, IUniTaskAsyncEnumerator<AsyncUnit>, IPlayerLoopItem
        {
            ...
            public _Timer(TimeSpan          dueTime,
                          TimeSpan?         period,
                          PlayerLoopTiming  updateTiming,
                          bool              ignoreTimeScale,
                          CancellationToken cancellationToken)
    ...
    internal class TimerFrame : IUniTaskAsyncEnumerable<AsyncUnit>
    {
        ...
        class _TimerFrame : MoveNextSource, IUniTaskAsyncEnumerator<AsyncUnit>, IPlayerLoopItem
        {
            ...
            public _TimerFrame(int               dueTimeFrameCount,
                               int?              periodFrameCount,
                               PlayerLoopTiming  updateTiming,
                               CancellationToken cancellationToken)
            {
